...
public class ErrorReporter extends JFrame {
	...
	public ErrorReporter(Throwable t, String message, ErrorManager manager) {
		...
		setStacktraceMessage(sw.getBuffer().toString());
	}
	...
	/**Create an empty swing {@link JFrame} that can display exception details once configured with {@link #setStacktraceMessage(String)}*/
	ErrorReporter() {
	...
	/**Set the stacktrace text area contents
