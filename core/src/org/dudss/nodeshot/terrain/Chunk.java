...
public class Chunk {
	...
	public enum EdgeType {
		BOTTOM_LEFT, BOTTOM_RIGHT, TOP_LEFT, TOP_RIGHT, END_LEFT, END_RIGHT, END_TOP, END_BOTTOM, SINGLE, NONE
	}
	...
	/**Flag/Unflag this {@link Chunk} as an edge
	 * @param edge Edge boolean
	 * @param edgetype Type of this edge
	 * @see {@link Chunk.EdgeType}
	 * */
	public void setEdge(boolean edge, EdgeType edgetype) {
		this.edge = true;
